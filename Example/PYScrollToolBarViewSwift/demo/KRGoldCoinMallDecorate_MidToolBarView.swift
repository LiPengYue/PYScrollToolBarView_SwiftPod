...
//        self.backgroundColor = UIColor.brown
        toolBarView.frame = CGRect.init(x: 30, y: 0, width: kViewCurrentW_XP(W: 300), height: kViewCurrentH_XP(H: 110))
        myGoldLabel.frame = CGRect.init(x: toolBarView.frame.maxX + kViewCurrentW_XP(W: 40), y: 0, width: kViewCurrentW_XP(W: 300), height: 30)
...
//        }
    ...
    lazy var toolBarView: PYToolBarView = {
        ...
        toolBarView.animaIndicatorBarViewH =  0
